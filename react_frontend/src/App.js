      ...
      <div className="row mt-3">
        <div className="col-sm-12 text-left">
            <Switch>
              ...
              <Route path="/01/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "01" state = {this.enhavo} />} />
              <Route path="/01/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "01" state = {this.enhavo} />} />
              ...
              <Route path="/02/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "02" state = {this.enhavo} />} />
              <Route path="/02/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "02" state = {this.enhavo} />} />
              ...
              <Route path="/03/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "03" state = {this.enhavo} />} />
              <Route path="/03/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "03" state = {this.enhavo} />} />
              ...
              <Route path="/04/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "04" state = {this.enhavo} />} />
              <Route path="/04/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "04" state = {this.enhavo} />} />
              ...
              <Route path="/05/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "05" state = {this.enhavo} />} />
              <Route path="/05/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "05" state = {this.enhavo} />} />
              ...
              <Route path="/06/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "06" state = {this.enhavo} />} />
              <Route path="/06/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "06" state = {this.enhavo} />} />
              ...
              <Route path="/07/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "07" state = {this.enhavo} />} />
              <Route path="/07/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "07" state = {this.enhavo} />} />
              ...
              <Route path="/08/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "08" state = {this.enhavo} />} />
              <Route path="/08/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "08" state = {this.enhavo} />} />
              ...
              <Route path="/09/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "09" state = {this.enhavo} />} />
              <Route path="/09/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "09" state = {this.enhavo} />} />
              ...
              <Route path="/10/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "10" state = {this.enhavo} />} />
              <Route path="/10/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "10" state = {this.enhavo} />} />
              ...
              <Route path="/11/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "11" state = {this.enhavo} />} />
              <Route path="/11/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "11" state = {this.enhavo} />} />
              ...
              <Route path="/12/vortoj"    render={ (routeProps) => <LekcioTeksto lekcio = "12" state = {this.enhavo} />} />
              <Route path="/12/gramatiko" render={ (routeProps) => <LekcioTeksto lekcio = "12" state = {this.enhavo} />} />
