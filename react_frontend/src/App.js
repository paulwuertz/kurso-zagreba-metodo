...
import Lekcioj from './pages/Lekcioj';
        ...
        <div className="row mt-3">
          <div className="col-sm-12 text-left">
              <Switch>
                ...
                <Route path="/01/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "01" state = {this.enhavo} />} />
                ...
                <Route path="/02/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "02" state = {this.enhavo} />} />
                ...
                <Route path="/03/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "03" state = {this.enhavo} />} />
                ...
                <Route path="/04/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "04" state = {this.enhavo} />} />
                ...
                <Route path="/05/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "05" state = {this.enhavo} />} />
                ...
                <Route path="/06/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "06" state = {this.enhavo} />} />
                ...
                <Route path="/07/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "07" state = {this.enhavo} />} />
                ...
                <Route path="/08/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "08" state = {this.enhavo} />} />
                ...
                <Route path="/09/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "09" state = {this.enhavo} />} />
                ...
                <Route path="/10/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "10" state = {this.enhavo} />} />
                ...
                <Route path="/11/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "11" state = {this.enhavo} />} />
                ...
                <Route path="/12/ekzercoj"  render={ (routeProps) => <Lekcioj lekcio = "12" state = {this.enhavo} />} />
